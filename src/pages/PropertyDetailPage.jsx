        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <nav
              ...
              className="flex text-xs text-stone-500 dark:text-stone-400 mb-3"
            >
            ...
            <p className="mt-2 text-stone-500 dark:text-stone-400 text-lg font-light flex capitalize items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section>
              ...
              <div className="rounded-xl overflow-hidden h-64 w-full bg-stone-200 dark:bg-stone-400 relative">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <div className="bg-boundry-primary text-white p-2 rounded-full shadow-lg ring-4 ring-white/30 dark:ring-stone-800/30">
